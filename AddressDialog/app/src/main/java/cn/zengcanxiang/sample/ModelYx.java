...
import cn.zengcanxiang.addressDialog.YxAddressModel;
...
public class ModelYx implements YxAddressModel<ProvinceBean, CityBean, DistrictBean> {
    ...
    public List<CityBean> getCity(ProvinceBean province) {
        ...
        list.add(new CityBean(11, "城市1111111111", province.getProvinceId()));
        list.add(new CityBean(12, "城市2", province.getProvinceId()));
        list.add(new CityBean(13, "城市3", province.getProvinceId()));
        return list;
    }
    ...
    public List<DistrictBean> getDistrict(CityBean city) {
        ...
        list.add(new DistrictBean(city.getCityId(), 111, "区县1"));
        list.add(new DistrictBean(city.getCityId(), 112, "区县2"));
        list.add(new DistrictBean(city.getCityId(), 113, "区县3"));
        return list;
    }
